...
def cellular_automaton(string, pattern_number, number_generations):
    patterns = {}
    list_pattern = ["...", "..x", ".x.", ".xx", "x..", "x.x", "xx.", "xxx"]
    n = len(string)
    #build my patterns distionary
    for i in range(7, -1, -1):
        if pattern_number/2**i == 1:
            patterns[list_pattern[i]] = "x"
            pattern_number = pattern_number - 2**i
        else:
            patterns[list_pattern[i]] = "."
